...
echo "Copying names.dmp to resources"
cp ${currentDir}/new_taxdump/names.dmp ${currentDir}/../src/main/resources
echo "Copying nodes.dmp to resources"
cp ${currentDir}/new_taxdump/nodes.dmp ${currentDir}/../src/main/resources
