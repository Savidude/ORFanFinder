...
$(document).ready(function() {
    ...
    $("#maxevalue").on('change', function() {
        $('#maxevaluevalue').text($("#maxevalue").val());
    });

    $("#maxtargets").on('change', function() {
        console.log($("#maxtargets").val())
        $('#maxtargetsvalue').text($("#maxtargets").val());
    });

    $.getJSON("data/TaxData.json", function(results) {
        results.forEach(function (result) {
            var option = result.speciesName + ' (' + result.ncbiTaxID + ')';
            organisms.push(option);
        })
    });

    autocomplete(document.getElementById("organismName"), organisms);
